...
export const consultants: Person[] = [
  ...
  { name: "Viswak Raja", role: "UX Design Consultant", initials: "VR", tone: "kai", bio: "" },
  { name: "Manas Mhasakar", role: "AI Consultant", initials: "MM", tone: "olena", bio: "" },
  { name: "Michael Parkin", role: "UX Designer & Developer", initials: "MP", tone: "ulu", bio: "" },
